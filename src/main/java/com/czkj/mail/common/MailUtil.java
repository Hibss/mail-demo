...
public class MailUtil {
    ...
    public static String myEmailAccount = "36402103@qq.com";
    public static String myEmailPassword = "hsszvscufnktcadf";//这个密码不是QQ密码或者邮箱密码，要验证的。自己百度
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "zhongba520@126.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("F:\\2019春游\\kefugzh1.png")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("F:\\2019春游\\账号.txt"));  // 读取本地文件
